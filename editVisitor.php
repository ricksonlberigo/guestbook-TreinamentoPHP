...
<body>
  <div class="container">
    <h2 class="text-center mt-5">Editando Visitante</h2>
    <?php if ($error) : ?>
    ...
    <?php else : ?>
      <form method="POST" class="mt-5">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="visitorName" placeholder="Atualizar Nome" name="name" value="<?= $visitor['name']; ?>" />
        </div>
        <input type="submit" value="Atualizar Visitante" class="btn btn-primary">
        <a href="listVisitor.php" class="btn btn-secondary">Voltar para a lista</a>
      </form>
    <?php endif; ?>
  </div>
</body>
